...
for i in range(num_trials):
    ...
    folder_name='results_cwbg_loop/cwbg_shared_acc/'+ImplementationName
    logDirectory=folder_name+'/log'
    checkpoint_restore_path=os.path.join(r'F:\Codes\joint attention\2022 - Journal\zST-GCN_CWBG_LOOP\checkpoints\cwbg_shared_acc',ImplementationName)
...
#-----------------
    ...
    if scheduler=='piecewise_decay':
        ...
        learning_rate = tf.keras.optimizers.schedules.ExponentialDecay(
                                        base_lr, decay_steps=iterationsOrSteps, decay_rate=0.96,staircase=False)
    else:
