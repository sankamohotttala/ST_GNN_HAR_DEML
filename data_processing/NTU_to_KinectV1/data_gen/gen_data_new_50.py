#this is for the new ntu-44 classes based implementations; 
#current implem: best, worst
import argparse
import pickle
...
max_frame = 300 #don't change this to 100 even if 10fps; it will be changed in the code itself
...
elif classes_list=='50_classes': 
    action_classes_used=list(range(1,50))+[59]
else:
...
if __name__ == '__main__':
    ...
    # output_folder=r'F:\Codes\joint attention\2022\NTU_to_KinectV1\sandbox_tmp'
    output_folder=r'F:\Codes\joint attention\2022\NTU_to_KinectV1\data_new_50_10fps'
