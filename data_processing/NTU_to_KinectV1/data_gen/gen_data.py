...
max_frame = 300
action_classes_used=list(range(1,50)) #uses action classes 
...
def gendata(data_path, out_path,extra_skeleton_path=None, ignored_sample_path=None, benchmark='xview', part='eval'):
    ...
    if extra_skeleton_path !=None:
        with open(extra_skeleton_path, 'r') as f:
            extra_skeleton_samples = [
...
if __name__ == '__main__':
    ...
    ignore_extra_skeleton_path=r'F:\Data Sets\Skeleton\3D\Adult\NTU dataset\processed skeleton data\Processed skeleton files\nturgbd_skeletons_s001_to_s017\extra_skeleton.txt'
    ...
    output_folder=r'F:\Codes\joint attention\2022\NTU_to_KinectV1\data'
    ...
    for b in benchmark:
        for p in part:
            ...
            gendata(data_path_final,
                out_path,ignore_extra_skeleton_path,
                ignored_sample_path,
                benchmark=b,
                part=p)
