...
max_frame = 300
action_classes_used=[6,8,10,14,20,26,27,31,35,43,59,
                    63,80,95,96,97,98,99,100,101,102,113] #uses action classes 
    ...
    for filename in os.listdir(data_path):
        ...
        if benchmark == 'xview':
            ...
            if action_class<60:
                ...
                istraining = (subject_id not in training_subjects)#this is needed because in NTU 120 more data are in val than train(?) ; check the charts file
        else:
            raise ValueError()
...
if __name__ == '__main__':
    ...
    output_folder=r'F:\Codes\joint attention\2022\NTU_to_KinectV1\data_4'
