#this is used tp create tfrecords for a large number of protocols in one go
import os
import pickle
import argparse
import numpy as np
...
if __name__ == '__main__':
    ...
    input_dir=r'F:\Codes\joint attention\2022\visualize_vattu_child\new_protocols'
   
    #go through every file using os.walk
    for root, dirs, files in os.walk(input_dir):
        if 'xsub' in dirs:
            output_folder=os.path.join(root,'xsub')
