...
sys.path.extend(['../'])
from pre_process_3d import pre_normalization
...
# action_class_list=[2,3,4,6,8,9,10,13,14,15]
# action_class_list=list(range(1,16))
action_class_list=[2,3,4,9,10,12,13,14]
...
if __name__ == '__main__':
    ...
    output_folder=r'F:\Codes\joint attention\2022\visualize_vattu_child\save_directory_Comparison'
