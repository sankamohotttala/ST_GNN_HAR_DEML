...
ChildDatasetClasses=44 #change the train, val data paths as well
ProtocolTraining='ntu_44_new_2_10fps' #since there is only one
batchSize=4

datatime=util.data_time_string() #used as a unique number as well so we know when the code was ran
LearningMode='forTF'  #without_strategy_testCross
FPS=30 #either 10 or 30
#checkpoint_restore_path=None        #this is given a value below
iterationNum=23924 #cwbg all - 924 #ntu-60: 38756 , ntu-120:71103
...
def get_dataset(directory, num_classes=60, batch_size=32, drop_remainder=False,
    ...
    def _parse_feature_function(example_proto):
        ...
        data = tf.reshape(data, (3, 100, 20, 1)) #changed both num_joints from 25 to 20 and num_skeletons from 2 to 1
        return data, label
