#copied from main_improved.py in zST-GCN
# useing for ntu_to_kinect_v1 implementations
...
# from model.stgcn_cwbg import Model  #use this with all other implementations
...
conf_fig_size=(64,48) #figure size for confusion matrix - small : (10,8), large : (64,48)
conf_annotation=True #if true then the numbers will be shown in the confusion matrix
tsne_fig_size=(25,25) # for small: (10,10) , for large: (25,25) , extra large: (30,30)
loss_fuction='softmax_cross' #softmax_cross or category_cross ->used for label smoothing
label_smooth_val=0.1 #0.1 is the default value; 0 is when no label smoothing done


#add other here
scheduler='piecewise_decay' #piecewise_decay or expo_decay
decay_rate=0.90 #.96 default ,.5 ->e-9 value, .75 -> 0.00017..
...
ChildDatasetClasses=60 #change the train, val data paths as well
ProtocolTraining='ntu_60_original' #since there is only one
batchSize=4

datatime=util.data_time_string() #used as a unique number as well so we know when the code was ran
LearningMode='recre'  #without_strategy_testCross
FPS=30 #either 10 or 30
#checkpoint_restore_path=None        #this is given a value below
iterationNum=38756 #cwbg all - 924 #ntu-60: 38756 , ntu-120:71103
...
used_epochs = 30
# for CFBG dataset
if ProtocolTraining=='ntu_44_new_1':    
    train_data_path = r'F:\Codes\joint attention\2022\NTU_to_KinectV1\data_new_44\xsub\train_data'
    test_data_path  = r'F:\Codes\joint attention\2022\NTU_to_KinectV1\data_new_44\xsub\val_data'
elif ProtocolTraining=='ntu_44_new_2':
    train_data_path = r'F:\Codes\joint attention\2022\NTU_to_KinectV1\data_new_44_2\xsub\train_data'
    test_data_path  = r'F:\Codes\joint attention\2022\NTU_to_KinectV1\data_new_44_2\xsub\val_data'
elif ProtocolTraining=='ntu_44_new_2_10fps':
    train_data_path = r'F:\Codes\joint attention\2022\NTU_to_KinectV1\data_new_44_2_10fps\xsub\train_data'
    test_data_path  = r'F:\Codes\joint attention\2022\NTU_to_KinectV1\data_new_44_2_10fps\xsub\val_data'
elif ProtocolTraining=='ntu_44_new_1_10fps':
    train_data_path = r'F:\Codes\joint attention\2022\NTU_to_KinectV1\data_new_44_10fps\xsub\train_data'
    test_data_path  = r'F:\Codes\joint attention\2022\NTU_to_KinectV1\data_new_44_10fps\xsub\val_data'
elif ProtocolTraining=='ntu_60_new': #on the newly pre-prcoessed data - no apparent change in pre-processing stage
    train_data_path = r'F:\Codes\joint attention\2022\NTU_to_KinectV1\data_new_60_new\xsub\train_data'
    test_data_path  = r'F:\Codes\joint attention\2022\NTU_to_KinectV1\data_new_60_new\xsub\val_data'
elif ProtocolTraining=='ntu_60_10fps': #on the newly pre-prcoessed data - no apparent change in pre-processing stage
    train_data_path = r'F:\Codes\joint attention\2022\NTU_to_KinectV1\data_6(10fps)\xsub\train_data'
    test_data_path  = r'F:\Codes\joint attention\2022\NTU_to_KinectV1\data_6(10fps)\xsub\val_data'
elif ProtocolTraining=='ntu_60_original': #this is for 300frame, 2 person, 25 joint original pre-processing
    train_data_path = r'F:\Codes\joint attention\2022 - Journal\Pre process\original_ntu_60\xsub\train_data'
    test_data_path  = r'F:\Codes\joint attention\2022 - Journal\Pre process\original_ntu_60\xsub\val_data'
elif ProtocolTraining=='cwbg_all':
...
elif ProtocolTraining =='ntu_120_10fps':
    train_data_path = r'F:\Codes\joint attention\2022\NTU_to_KinectV1\data_7(10fps)\xsub\train_data'
    test_data_path  = r'F:\Codes\joint attention\2022\NTU_to_KinectV1\data_7(10fps)\xsub\val_data'
else:
    ValueError()
...
folder_name='results/'+ImplementationName
logDirectory=folder_name+'/log'
main_checkpoint=r'F:\Codes\joint attention\2022 - Journal\New TF and NTU-44  implementations\New_train_for_v1\checkpoints'
checkpoint_restore_path=os.path.join(main_checkpoint,datatime)
...
def get_dataset(directory, num_classes=60, batch_size=32, drop_remainder=False,
    ...
    def _parse_feature_function(example_proto):
        ...
        data = tf.reshape(data, (3, 300, 25, 2)) #changed both num_joints from 25 to 20 and num_skeletons from 2 to 1
        return data, label
