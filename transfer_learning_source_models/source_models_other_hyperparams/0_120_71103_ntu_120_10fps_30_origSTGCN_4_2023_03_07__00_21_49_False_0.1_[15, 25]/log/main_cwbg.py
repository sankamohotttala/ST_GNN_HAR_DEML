...
tsne_fig_size=(30,30) # for small: (10,10) , for large: (25,25) , extra large: (30,30)
...
ChildDatasetClasses=120 #change the train, val data paths as well
ProtocolTraining='ntu_120_10fps' #since there is only one
batchSize=4

datatime=util.data_time_string() #used as a unique number as well so we know when the code was ran
LearningMode='origSTGCN'  #without_strategy_testCross
FPS=30 #either 10 or 30
#checkpoint_restore_path=None        #this is given a value below
iterationNum=71103 #cwbg all - 924 #ntu-60: 38756 , ntu-120:71103
