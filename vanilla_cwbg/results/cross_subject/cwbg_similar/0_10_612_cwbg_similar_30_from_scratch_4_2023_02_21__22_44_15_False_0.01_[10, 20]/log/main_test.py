...
for i in range(num_trials):
    ...
    ProtocolTraining='cwbg_similar' #since there is only one
    batchSize=4
    ...
    iterationNum=612 #cwbg all - 924 , similar - 612, dissimilar - 628
    ...
    folder_name='results_cwbg_loop/cwbg similar/'+ImplementationName
    logDirectory=folder_name+'/log'
    checkpoint_restore_path=os.path.join(r'F:\Codes\joint attention\2022 - Journal\zST-GCN_CWBG_LOOP\checkpoints\cwbg similar',ImplementationName)
