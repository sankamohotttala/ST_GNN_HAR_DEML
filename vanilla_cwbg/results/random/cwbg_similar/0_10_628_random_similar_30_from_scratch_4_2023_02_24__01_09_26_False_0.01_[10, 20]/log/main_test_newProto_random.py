...
for i in range(num_trials):
    ...
    ProtocolTraining='random_similar' #since there is only one
    batchSize=4
    ...
    folder_name='results_randomSplit/similar/'+ImplementationName
    logDirectory=folder_name+'/log' 
    checkpoint_restore_path=os.path.join(r'F:\Codes\joint attention\2022 - Journal\zST-GCN_CWBG_LOOP\checkpoints\ran_simil',ImplementationName)
