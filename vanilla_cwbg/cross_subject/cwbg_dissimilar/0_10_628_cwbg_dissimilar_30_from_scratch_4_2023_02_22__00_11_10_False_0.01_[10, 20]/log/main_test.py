...
for i in range(num_trials):
    ...
    folder_name='results_cwbg_loop/cwbg shared/'+ImplementationName
    logDirectory=folder_name+'/log'
    checkpoint_restore_path=os.path.join(r'F:\Codes\joint attention\2022 - Journal\zST-GCN_CWBG_LOOP\checkpoints\cwbg shared',ImplementationName)
