...
# useing for cwbg implementations
...
for i in range(num_trials):
    ...
    iterationNum=924 #cwbg all - 924 , similar - 612, dissimilar - 628
    ...
    # for CFBG dataset
    if ProtocolTraining=='sample_60':    
        train_data_path = r'F:\Codes\joint attention\2022 - Journal\Pre process\sandbox\xsub\train_data'
        test_data_path  = r'F:\Codes\joint attention\2022 - Journal\Pre process\sandbox\xsub\val_data'
    elif ProtocolTraining=='full_60':
        train_data_path = r'F:\Codes\joint attention\2022 - Journal\Pre process\original_60_invarient\xsub\train_data' 
        test_data_path  = r'F:\Codes\joint attention\2022 - Journal\Pre process\original_60_invarient\xsub\val_data'
    ...
    folder_name='results_cwbg_loop/'+ImplementationName
    logDirectory=folder_name+'/log'
    checkpoint_restore_path=os.path.join(r'F:\Codes\joint attention\2022 - Journal\zST-GCN_CWBG_LOOP\checkpoints',ImplementationName)
