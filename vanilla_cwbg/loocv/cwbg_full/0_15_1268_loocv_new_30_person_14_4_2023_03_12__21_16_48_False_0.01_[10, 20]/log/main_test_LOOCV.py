...
for child in range(num_children): #child from 0 to 29
    ...
    ProtocolTraining='loocv_new' #since there is only one
    batchSize=4
    ...
    iterationNum=1268 #cwbg all - 1268  , similar - 840 , dissimilar - 868, shared -432
    ...
    elif ProtocolTraining=='loocv_sim':
        train_data_path=r'F:\Codes\joint attention\2022\visualize_vattu_child\new_protocols\for_LOOCV\similar\xsub\train_data'
        test_data_path =r'F:\Codes\joint attention\2022\visualize_vattu_child\new_protocols\for_LOOCV\similar\xsub\val_data'
    else:
        ValueError()
    ...
    folder_name='results_cwbg_new_protocol/loocv_ful__/'+ImplementationName #root folder also gets created 
    logDirectory=folder_name+'/log'
    checkpoint_restore_path=os.path.join(r'F:\Codes\joint attention\2022 - Journal\zST-GCN_CWBG_LOOP\checkpoints\loocv_ful__',ImplementationName)
