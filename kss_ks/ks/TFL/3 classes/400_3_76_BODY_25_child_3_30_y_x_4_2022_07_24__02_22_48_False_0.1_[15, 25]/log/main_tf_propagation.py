...
save_all_data=False
skeleton_structure='coco' # others are  'coco' and 'no_foot';
...
PreTrainedClasses=400 #since no transfer learning here
...
used_epochs = 30 #70
checkpoint_restore_path='checkpoints/Class400_2'
# for CFBG dataset
...
if __name__ == "__main__":
    ...
    with strategy.scope():
        ...
        status = ckpt.restore(checkpoint_list[2]) #checkpoint_last
