...
def plotAccuracy(train_epoch,test_epoch,cross_loss,cross_loss_2,epochsNumber,train_ite,lr,final=True):
...
if __name__ == "__main__":
    ...
    for epoch in range(epochs):
        ...
        if (epoch + 1) % save_freq == 0:
            ...
            print('Saving checkpoint for epoch {} at {}'.format(epoch+1,
                                                                ckpt_save_path))
        if (epoch + 1) % save_freq == 0:
            plotAccuracy(matrixMatplot.train_epoch_acc,matrixMatplot.test_epoch_acc,matrixMatplot.cross_entrophy_loss_3,matrixMatplot.cross_entrophy_loss_2,epoch+1,train_iter,matrixMatplot.lr,False)
    ...
    plotAccuracy(matrixMatplot.train_epoch_acc,matrixMatplot.test_epoch_acc,matrixMatplot.cross_entrophy_loss_3,matrixMatplot.cross_entrophy_loss_2,epochs,train_iter,matrixMatplot.lr,True)
