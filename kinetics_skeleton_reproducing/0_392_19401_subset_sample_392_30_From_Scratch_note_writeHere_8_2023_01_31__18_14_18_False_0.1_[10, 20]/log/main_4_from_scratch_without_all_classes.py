...
ChildDatasetClasses=392 #change the train, val data paths as well
ProtocolTraining='subset_sample_392' #since there is only one
batchSize=8
...
iterationNum=19401  #234951 for all train samples  
...
if ProtocolTraining=='sample_400':    
    ...
    train_data_path = r'F:\Codes\joint attention\2022 - Journal\kinetics-skeleton subsets\test\train_data' #there are  8 classes
    test_data_path  = r'F:\Codes\joint attention\2022 - Journal\kinetics-skeleton subsets\test\val_data'
elif ProtocolTraining=='subset_sample_392':
    train_data_path = r'F:\Codes\joint attention\2022 - Journal\kinetics-skeleton subsets\test\val_data' #there are  8 classes
    test_data_path  = r'F:\Codes\joint attention\2022 - Journal\kinetics-skeleton subsets\test\val_data'
else:
    ValueError()
...
def get_parser():
    ...
    parser.add_argument(
        '--save-freq', type=int, default=1, help='periodicity of saving model weights')
    parser.add_argument(
        '--checkpoint-path',
        '--checkpoint-path',                                                                                                                          
...
def confusion_matrix_draw(predict,label,iteration,test_ite):
    ...
    sns.heatmap(confusion_mtx,xticklabels=classList,yticklabels=classList,  annot=False, fmt='.2f')
