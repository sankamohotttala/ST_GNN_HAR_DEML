...
class SGCN(tf.keras.Model):
    def __init__(self,filters=None, kernel_size=3):#probably this kernal size is related to the channel number may be change it to 2?
        super().__init__()
...
class Model(tf.keras.Model):
    def __init__(self, num_classes=60,layer_out=10):
...
class Model2(tf.keras.Model):
    def __init__(self, num_classes=10):
        ...
        self.dense1=tf.keras.layers.Dense(196, activation='relu',kernel_initializer=INITIALIZER,kernel_regularizer=REGULARIZER) #256
        self.dense2=tf.keras.layers.Dense(128, activation='relu',kernel_initializer=INITIALIZER,kernel_regularizer=REGULARIZER)
