...
from model.stgcn_save import Model  #use this with all other implementations
...
used_epochs = 30
checkpoint_name='NEW_60' #folder name
...
if __name__ == "__main__":
    ...
    # status = ckpt.restore(checkpoint_list[4])  
    ...
    dicTrain,dicTest,dicPrec,overallStr,trainNorm,testNorm=util.getTrainTestDistribution(train_data,test_data,batch_size,60)
    ...
    for epoch in range(epochs):
        ...
        for features, labels in tqdm(test_data):
            ...
            if (epoch + 1) % save_freq == 0:
                ...
                model.save_weights("1_pretrained_ckpt")
                break
