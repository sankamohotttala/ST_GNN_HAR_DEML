...
#             }
config_2 = {1: { 'target_classes': 5, 'source_cls':120,'proto':'S4','lr': 0.01,'steps':[15,25], 'optimizer':'SGD','batch_size': 4, 'epochs': 30, 'stgcn_out': 10,  'FPS':30},
            2: { 'target_classes': 5, 'source_cls':60,'proto':'S4','lr': 0.01,'steps':[15,25], 'optimizer':'SGD','batch_size': 4, 'epochs': 30, 'stgcn_out': 10,  'FPS':30},
            3: { 'target_classes': 5, 'source_cls':22,'proto':'S4','lr': 0.01,'steps':[15,25], 'optimizer':'SGD','batch_size': 4, 'epochs': 30, 'stgcn_out': 10,  'FPS':30},
            4: { 'target_classes': 5, 'source_cls':44,'proto':'S4','lr': 0.01,'steps':[15,25], 'optimizer':'SGD','batch_size': 4, 'epochs': 30, 'stgcn_out': 10, 'FPS':30},
            5: { 'target_classes': 5, 'source_cls':60,'proto':'S4','lr': 0.01,'steps':[15,25], 'optimizer':'SGD','batch_size': 4, 'epochs': 30, 'stgcn_out': 10,  'FPS':30},
            6: { 'target_classes': 5, 'source_cls':120,'proto':'S4','lr': 0.01,'steps':[15,25], 'optimizer':'SGD','batch_size': 4, 'epochs': 30, 'stgcn_out': 10, 'FPS':30}            
            }
