...
#config dics
config = {1: {'schedular':'expo','decay':0.92,'loss_func':'category_cross','label_smooth_val':0.0,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.001,'epochs_fc':3},
          2: {'schedular':'expo','decay':0.92,'loss_func':'category_cross','label_smooth_val':0.1,'scale':1., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.01,'epochs_fc':3},
          ...
          4: {'schedular':'expo','decay':0.94,'loss_func':'category_cross','label_smooth_val':0.1,'scale':1., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.01,'epochs_fc':3},
          5: {'schedular':'expo','decay':0.96,'loss_func':'category_cross','label_smooth_val':0.1,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.001,'epochs_fc':3},
          6: {'schedular':'expo','decay':0.96,'loss_func':'category_cross','label_smooth_val':0.1,'scale':1., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.01,'epochs_fc':3}
          }
