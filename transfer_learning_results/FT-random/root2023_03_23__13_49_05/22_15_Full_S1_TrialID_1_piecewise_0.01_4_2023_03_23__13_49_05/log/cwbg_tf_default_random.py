...
#non looping config
config_2 = {1: { 'target_classes': 15, 'source_cls':22,'proto':'S1','lr': 0.01,'steps':[10,20], 'optimizer':'SGD','batch_size': 4, 'epochs': 30, 'stgcn_out':9, 'FPS':30},
            2: { 'target_classes': 10, 'source_cls':22,'proto':'S2','lr': 0.01,'steps':[10,20], 'optimizer':'SGD','batch_size': 4, 'epochs': 30, 'stgcn_out':9, 'FPS':30},
            3: { 'target_classes': 10, 'source_cls':22,'proto':'S3','lr': 0.01,'steps':[10,20], 'optimizer':'SGD','batch_size': 4, 'epochs': 30, 'stgcn_out':9, 'FPS':30},
            4: { 'target_classes': 5, 'source_cls':22,'proto':'S4','lr': 0.01,'steps':[10,20], 'optimizer':'SGD','batch_size': 4, 'epochs': 30, 'stgcn_out':9, 'FPS':30}
            }
