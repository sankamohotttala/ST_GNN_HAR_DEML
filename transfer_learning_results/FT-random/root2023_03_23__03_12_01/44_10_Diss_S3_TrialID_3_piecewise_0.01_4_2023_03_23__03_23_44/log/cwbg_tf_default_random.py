...
#config dics
config = {1: {'schedular':'piecewise','decay':0.92,'loss_func':'category_cross','label_smooth_val':0,'scale':1., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.0001,'epochs_fc':3},
          2: {'schedular':'piecewise','decay':0.92,'loss_func':'category_cross','label_smooth_val':0,'scale':1., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.0001,'epochs_fc':3},
          3: {'schedular':'piecewise','decay':0.92,'loss_func':'category_cross','label_smooth_val':0,'scale':1., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.0001,'epochs_fc':3},
          4: {'schedular':'piecewise','decay':0.92,'loss_func':'category_cross','label_smooth_val':0,'scale':1., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.0001,'epochs_fc':3},
          5: {'schedular':'piecewise','decay':0.92,'loss_func':'category_cross','label_smooth_val':0,'scale':1., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.0001,'epochs_fc':3},
          6: {'schedular':'piecewise','decay':0.92,'loss_func':'category_cross','label_smooth_val':0,'scale':1., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.0001,'epochs_fc':3}
          }
