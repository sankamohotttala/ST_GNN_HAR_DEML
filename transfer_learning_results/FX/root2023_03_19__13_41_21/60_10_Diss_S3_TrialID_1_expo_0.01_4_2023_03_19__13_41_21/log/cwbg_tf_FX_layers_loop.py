...
def reliabilityDigram_2(dataframe, class_num, epoch_num, bin_n=10):
    ...
    for i in range(class_num):
        ...
        plt.savefig(os.path.join(pathDirectoryRD_epoch,f'reliability_diagram_class_id_{CLASS}.png'))
        plt.grid('off')
        # plt.show()
        plt.close()
...
#config dics
config = {1: {'schedular':'expo','decay':0.9,'loss_func':'category_cross','label_smooth_val':0.5,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.01},
          2:{'schedular':'expo','decay':0.9,'loss_func':'category_cross','label_smooth_val':0.6,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.01},
          3:{'schedular':'expo','decay':0.9,'loss_func':'category_cross','label_smooth_val':0.7,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.01},
          4:{'schedular':'expo','decay':0.9,'loss_func':'category_cross','label_smooth_val':0.8,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.01},
          5:{'schedular':'expo','decay':0.9,'loss_func':'category_cross','label_smooth_val':0.9,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.01},
          6:{'schedular':'expo','decay':0.9,'loss_func':'category_cross','label_smooth_val':0.99,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.01}
          }
