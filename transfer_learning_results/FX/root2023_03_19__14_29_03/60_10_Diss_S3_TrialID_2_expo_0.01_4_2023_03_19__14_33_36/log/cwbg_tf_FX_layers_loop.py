...
#config dics
config = {1: {'schedular':'expo','decay':0.9,'loss_func':'category_cross','label_smooth_val':0,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.01},
          2:{'schedular':'expo','decay':0.9,'loss_func':'category_cross','label_smooth_val':0.1,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.01},
          3:{'schedular':'expo','decay':0.9,'loss_func':'category_cross','label_smooth_val':0.2,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.01},
          4:{'schedular':'expo','decay':0.9,'loss_func':'category_cross','label_smooth_val':0.3,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.01},
          5:{'schedular':'expo','decay':0.9,'loss_func':'category_cross','label_smooth_val':0.4,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.01},
          6:{'schedular':'expo','decay':0.9,'loss_func':'category_cross','label_smooth_val':0.5,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.01}
          }
