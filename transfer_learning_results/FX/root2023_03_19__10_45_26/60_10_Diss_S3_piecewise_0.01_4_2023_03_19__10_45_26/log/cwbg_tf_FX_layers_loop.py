...
#config dics
config = {1: {'schedular':'piecewise','decay':0.9,'loss_func':'category_cross','label_smooth_val':0.1,'scale':2., 'mode':'fan_in', 'dist':'truncated_normal','reg':'l2','reg_valu':0.01},
          2:{'schedular':'piecewise','decay':0.9,'loss_func':'category_cross','label_smooth_val':0.1,'scale':3., 'mode':'fan_in', 'dist':'truncated_normal','reg':'l2','reg_valu':0.01},
          3:{'schedular':'piecewise','decay':0.9,'loss_func':'category_cross','label_smooth_val':0.1,'scale':4., 'mode':'fan_in', 'dist':'truncated_normal','reg':'l2','reg_valu':0.01},
          4:{'schedular':'piecewise','decay':0.9,'loss_func':'category_cross','label_smooth_val':0.1,'scale':1., 'mode':'fan_in', 'dist':'truncated_normal','reg':'l2','reg_valu':0.01}
          }
