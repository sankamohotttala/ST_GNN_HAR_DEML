...
config = {1: {'schedular':'piecewise','decay':0.9,'loss_func':'category_cross','label_smooth_val':0.1,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.001},
          2: {'schedular':'piecewise','decay':0.9,'loss_func':'category_cross','label_smooth_val':0.1,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.001},
          3: {'schedular':'piecewise','decay':0.9,'loss_func':'category_cross','label_smooth_val':0.1,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.001},
          4: {'schedular':'piecewise','decay':0.9,'loss_func':'category_cross','label_smooth_val':0.1,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.001},
          5: {'schedular':'piecewise','decay':0.9,'loss_func':'category_cross','label_smooth_val':0.1,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.001},
          6: {'schedular':'piecewise','decay':0.9,'loss_func':'category_cross','label_smooth_val':0.1,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.001}
          }

#non looping config
config_2 = {1: { 'target_classes': 15, 'source_cls':120,'proto':'S1','lr': 0.01,'steps':[10,20], 'optimizer':'ADAM','batch_size': 4, 'epochs': 30, 'STGCN_OUT':10,'FPS':30},
            2: { 'target_classes': 10, 'source_cls':120,'proto':'S2','lr': 0.01,'steps':[10,20], 'optimizer':'ADAM','batch_size': 4, 'epochs': 30, 'STGCN_OUT':10,'FPS':30},
            3: { 'target_classes': 10, 'source_cls':120,'proto':'S3','lr': 0.01,'steps':[10,20], 'optimizer':'ADAM','batch_size': 4, 'epochs': 30, 'STGCN_OUT':10,'FPS':30},
            4: { 'target_classes': 5, 'source_cls':120,'proto':'S4','lr': 0.01,'steps':[10,20], 'optimizer':'ADAM','batch_size': 4, 'epochs': 30, 'STGCN_OUT':10,'FPS':30}
            }
