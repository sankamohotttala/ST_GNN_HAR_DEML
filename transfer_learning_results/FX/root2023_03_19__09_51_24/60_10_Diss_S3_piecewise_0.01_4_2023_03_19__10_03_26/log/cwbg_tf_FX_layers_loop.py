...
def reliabilityDigram(path, class_num, bin_n=10):
    ...
    for i in range(CLASS):
        ...
        plt.savefig(os.path.join('reliability_diagrams','sklearn',f'reliability_diagram_sklearn_{CLASS}.png'))
        # plt.show()
        plt.close()
...
#config dics
config = {1: {'schedular':'piecewise','decay':0.9,'loss_func':'category_cross','label_smooth_val':0.1,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l1','reg_valu':0.01},
          2:{'schedular':'piecewise','decay':0.9,'loss_func':'category_cross','label_smooth_val':0.1,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l1','reg_valu':0.1},
          ...
          4:{'schedular':'piecewise','decay':0.9,'loss_func':'category_cross','label_smooth_val':0.1,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.1}
          }
