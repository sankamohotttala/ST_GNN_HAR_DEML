...
#config dics
config = {1: {'schedular':'expo','decay':0.96,'loss_func':'category_cross','label_smooth_val':0.1,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.001},
          2: {'schedular':'expo','decay':0.96,'loss_func':'category_cross','label_smooth_val':0.1,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.001},
          3: {'schedular':'expo','decay':0.96,'loss_func':'category_cross','label_smooth_val':0.1,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.001},
          4: {'schedular':'expo','decay':0.96,'loss_func':'category_cross','label_smooth_val':0.1,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.001},
          5: {'schedular':'expo','decay':0.96,'loss_func':'category_cross','label_smooth_val':0.1,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.001},
          6: {'schedular':'expo','decay':0.96,'loss_func':'category_cross','label_smooth_val':0.1,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.001}
          }
...
config_2 = {1: { 'target_classes': 10, 'source_cls':60,'proto':'S3','lr': 0.01,'steps':[10,20], 'optimizer':'SGD','batch_size': 4, 'epochs': 30, 'STGCN_OUT':10,'FPS':30},
            2: { 'target_classes': 5, 'source_cls':60,'proto':'S4','lr': 0.01,'steps':[10,20], 'optimizer':'SGD','batch_size': 4, 'epochs': 30, 'STGCN_OUT':10,'FPS':30},
...
for ind in range(1,trials+1):
    ind_2 = ind if not config_2_static else 1 #if True -> 1 else -> ind
