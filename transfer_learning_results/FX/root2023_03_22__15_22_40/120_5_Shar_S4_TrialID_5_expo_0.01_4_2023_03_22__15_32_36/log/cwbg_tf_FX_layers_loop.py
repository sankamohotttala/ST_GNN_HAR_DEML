...
#config dics
config = {1: {'schedular':'expo','decay':0.9,'loss_func':'category_cross','label_smooth_val':0.1,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.001},
          2: {'schedular':'expo','decay':0.9,'loss_func':'category_cross','label_smooth_val':0.1,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.0001},
          3: {'schedular':'expo','decay':0.9,'loss_func':'category_cross','label_smooth_val':0.1,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.1},
          4: {'schedular':'expo','decay':0.92,'loss_func':'category_cross','label_smooth_val':0.1,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.001},
          5: {'schedular':'expo','decay':0.92,'loss_func':'category_cross','label_smooth_val':0.1,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.0001},
          6: {'schedular':'expo','decay':0.92,'loss_func':'category_cross','label_smooth_val':0.1,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.1}
          }
