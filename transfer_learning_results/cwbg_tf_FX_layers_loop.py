...
#config dics
config = {1: {'schedular':'expo','decay':0.88,'loss_func':'category_cross','label_smooth_val':0.1,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.0001},
          2: {'schedular':'expo','decay':0.88,'loss_func':'category_cross','label_smooth_val':0.1,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.0001},
          3: {'schedular':'expo','decay':0.88,'loss_func':'category_cross','label_smooth_val':0.1,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.0001},
          4: {'schedular':'expo','decay':0.88,'loss_func':'category_cross','label_smooth_val':0.1,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.0001},
          5: {'schedular':'expo','decay':0.88,'loss_func':'category_cross','label_smooth_val':0.1,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.0001},
          6: {'schedular':'expo','decay':0.88,'loss_func':'category_cross','label_smooth_val':0.1,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.0001}
          }

#non looping config
config_2 = {1: { 'target_classes': 15, 'source_cls':120,'proto':'S1','lr': 0.01,'steps':[10,20], 'optimizer':'SGD','batch_size': 4, 'epochs': 30, 'STGCN_OUT':10,'FPS':30},
            2: { 'target_classes': 10, 'source_cls':120,'proto':'S2','lr': 0.01,'steps':[10,20], 'optimizer':'SGD','batch_size': 4, 'epochs': 30, 'STGCN_OUT':10,'FPS':30},
            3: { 'target_classes': 10, 'source_cls':120,'proto':'S3','lr': 0.01,'steps':[10,20], 'optimizer':'SGD','batch_size': 4, 'epochs': 30, 'STGCN_OUT':10,'FPS':30},
            4: { 'target_classes': 5, 'source_cls':120,'proto':'S4','lr': 0.01,'steps':[10,20], 'optimizer':'SGD','batch_size': 4, 'epochs': 30, 'STGCN_OUT':10,'FPS':30}
            }
...
weight_path=r'F:\Codes\joint attention\2022 - Journal\New TF and NTU-44  implementations\Create weights\save_weights\NTU 120 10FPS\ntu120_10fps' #last ntu120 is necessary
...
for ind in range(1,trials+1):
    ...
    STGCN_OUT=config_2[ind_2]['STGCN_OUT'] #stgcn output layer - 1 to 10
