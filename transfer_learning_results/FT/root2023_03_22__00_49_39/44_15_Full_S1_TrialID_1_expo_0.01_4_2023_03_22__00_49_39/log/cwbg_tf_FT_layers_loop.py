...
#config dics
config = {1: {'schedular':'expo','decay':0.92,'loss_func':'category_cross','label_smooth_val':0.1,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.001,'epochs_fc':3},
          ...
          3: {'schedular':'expo','decay':0.92,'loss_func':'category_cross','label_smooth_val':0.1,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.001,'epochs_fc':3},
...
#non looping config
config_2 = {1: { 'target_classes': 15, 'source_cls':44,'proto':'S1','lr': 0.01,'steps':[10,20], 'optimizer':'SGD','batch_size': 4, 'epochs': 30, 'S':10, 'E':11, 'FPS':30},
            2: { 'target_classes': 10, 'source_cls':44,'proto':'S2','lr': 0.01,'steps':[10,20], 'optimizer':'SGD','batch_size': 4, 'epochs': 30, 'S':10, 'E':11, 'FPS':30},
            3: { 'target_classes': 10, 'source_cls':44,'proto':'S3','lr': 0.01,'steps':[10,20], 'optimizer':'SGD','batch_size': 4, 'epochs': 30, 'S':10, 'E':11, 'FPS':30},
...
weight_path=r'F:\Codes\joint attention\2022 - Journal\New TF and NTU-44  implementations\Create weights\save_weights\NTU 44 - best\ntu44best' #last ntu120 is necessary
