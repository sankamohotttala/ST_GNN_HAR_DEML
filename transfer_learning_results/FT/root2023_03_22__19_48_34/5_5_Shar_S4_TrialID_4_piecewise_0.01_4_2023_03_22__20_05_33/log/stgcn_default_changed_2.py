...
class Model(tf.keras.Model):
    def __init__(self, num_classes=60,layer_out = -1,initializers=None):
...
class Model2_new(tf.keras.Model):
    def __init__(self, num_classes=10,intializers=None):
        ...
        self.dense1=tf.keras.layers.Dense(256, activation='relu',kernel_initializer=self.intializers.INITIALIZER,kernel_regularizer=self.intializers.REGULARIZER) # 512 originally
...
class Model2_single_layer(tf.keras.Model):
    def __init__(self, num_classes=10,intializers=None):
        ...
        self.dense3=tf.keras.layers.Dense(num_classes, kernel_initializer=self.intializers.INITIALIZER, kernel_regularizer=self.intializers.REGULARIZER)
