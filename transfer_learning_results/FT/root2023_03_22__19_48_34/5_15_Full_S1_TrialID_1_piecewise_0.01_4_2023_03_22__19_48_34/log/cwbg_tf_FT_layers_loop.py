...
config = {1: {'schedular':'piecewise','decay':0.90,'loss_func':'category_cross','label_smooth_val':0,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.001,'epochs_fc':3},
          2: {'schedular':'piecewise','decay':0.90,'loss_func':'category_cross','label_smooth_val':0,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.001,'epochs_fc':3},
          3: {'schedular':'piecewise','decay':0.90,'loss_func':'category_cross','label_smooth_val':0,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.001,'epochs_fc':3},
          4: {'schedular':'piecewise','decay':0.90,'loss_func':'category_cross','label_smooth_val':0,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.001,'epochs_fc':3},
          5: {'schedular':'piecewise','decay':0.90,'loss_func':'category_cross','label_smooth_val':0,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.001,'epochs_fc':3},
          6: {'schedular':'piecewise','decay':0.90,'loss_func':'category_cross','label_smooth_val':0,'scale':2., 'mode':'fan_out', 'dist':'truncated_normal','reg':'l2','reg_valu':0.001,'epochs_fc':3}
          }

# #non looping config
config_2 = {1: { 'target_classes': 15, 'source_cls':5,'proto':'S1','lr': 0.01,'steps':[15,25], 'optimizer':'SGD','batch_size': 4, 'epochs': 30, 'S':10, 'E':11, 'FPS':30},
            2: { 'target_classes': 10, 'source_cls':5,'proto':'S2','lr': 0.01,'steps':[15,25], 'optimizer':'SGD','batch_size': 4, 'epochs': 30, 'S':10, 'E':11, 'FPS':30},
            3: { 'target_classes': 10, 'source_cls':5,'proto':'S3','lr': 0.01,'steps':[15,25], 'optimizer':'SGD','batch_size': 4, 'epochs': 30, 'S':10, 'E':11, 'FPS':30},
            4: { 'target_classes': 5, 'source_cls':5,'proto':'S4','lr': 0.01,'steps':[15,25], 'optimizer':'SGD','batch_size': 4, 'epochs': 30, 'S':10, 'E':11, 'FPS':30}
            }
# config_2 = {1: { 'target_classes': 5, 'source_cls':120,'proto':'S4','lr': 0.01,'steps':[15,25], 'optimizer':'SGD','batch_size': 4, 'epochs': 30, 'S':10, 'E':11, 'FPS':30},
#             2: { 'target_classes': 5, 'source_cls':60,'proto':'S4','lr': 0.01,'steps':[15,25], 'optimizer':'SGD','batch_size': 4, 'epochs': 30, 'S':10, 'E':11, 'FPS':30},
#             3: { 'target_classes': 5, 'source_cls':22,'proto':'S4','lr': 0.01,'steps':[15,25], 'optimizer':'SGD','batch_size': 4, 'epochs': 30, 'S':10, 'E':11, 'FPS':30},
#             4: { 'target_classes': 5, 'source_cls':44,'proto':'S4','lr': 0.01,'steps':[15,25], 'optimizer':'SGD','batch_size': 4, 'epochs': 30, 'S':10, 'E':11, 'FPS':30},
#             5: { 'target_classes': 5, 'source_cls':60,'proto':'S4','lr': 0.01,'steps':[15,25], 'optimizer':'SGD','batch_size': 4, 'epochs': 30, 'S':10, 'E':11, 'FPS':30},
#             6: { 'target_classes': 5, 'source_cls':120,'proto':'S4','lr': 0.01,'steps':[15,25], 'optimizer':'SGD','batch_size': 4, 'epochs': 30, 'S':10, 'E':11, 'FPS':30}            
#             }
...
weight_path=r'F:\Codes\joint attention\2022 - Journal\New TF and NTU-44  implementations\Create weights\save_weights\NTU 5\ntu5' #last ntu120 is necessary
# weight_path_config = {1:r'F:\Codes\joint attention\2022 - Journal\New TF and NTU-44  implementations\Create weights\save_weights\NTU 120\CKPT 7\ntu120',
