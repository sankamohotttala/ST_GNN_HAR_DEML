...
#note we need to create the root checkpoint and results folders 
...
for i in range(num_trials):
    ...
    LearningMode='_'  #without_strategy_testCross
    ...
    folder_name='sandbox/test/'+ImplementationName
    logDirectory=folder_name+'/log'
    checkpoint_restore_path=os.path.join(r'F:\Codes\joint attention\2022 - Journal\zST-GCN_CWBG_LOOP\sandbox\checkpoints',ImplementationName)
...
#-----------------
    ...
    base_lr         = base_lr
    num_classes     = ChildDatasetClasses
    epochs          = used_epochs
    checkpoint_path = checkpoint_restore_path
    ...
    shutil.copy2(inspect.getfile(Model), log_dir)
    shutil.copy2(__file__, log_dir)#save main(this file itseld) to log
